...
const Notifications = memo(function Notifications () {
  ...
  // loading and notifications are co-located to simplify conditional rendering.
  ...
  return (
    <>
      ...
      {loading ? (
        // Show explicit fetch feedback before notifications are available.
        ...
        <div data-testid="notification-drawer" className={css(styles.notificationItems)} ref={DrawerRef}>
          {notifications && notifications.length > 0 ? (
            <>
              ...
              <button type="button" onClick={handleToggleDrawer} aria-label="Close" className={css(styles.button)}>
